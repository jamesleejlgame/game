/**
 * Each variable is an array of rpg dialogue objects.
 *
 * These objects have the following keys:
 * @key {string} m: The message.
 * @key {string} question: The question to ask.
 * @key {array<RpgDialogue object>} answers: The possible answers to the question.
...
Rpg.Data.Dialogue = {
  ...
  christinaLocksJamesInAlcatraz1: [
